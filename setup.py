...
setup(
    ...
    description="This package provides ressources for analyzing results of FSPM simulations",
    ...
    url="https://github.com/GeraultTr/analyze.git",
    download_url="https://github.com/GeraultTr/analyze.git"
)
