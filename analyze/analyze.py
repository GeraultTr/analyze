...
def analyze_data(scenarios, outputs_dirpath, inputs_dirpath, on_sums=False, on_raw_logs=False, animate_raw_logs=False, on_shoot_logs=False, on_performance=False,
    ...
    if animate_raw_logs:
        ...
        dataset["Lengthy_Net_AA_Exudation"] = Indicators.compute(d=dataset, formula="(diffusion_AA_soil + apoplastic_AA_soil_xylem - import_AA) / length")
        ...
        if autonomous_figures:
            ...
            subdataset = dataset[["distance_from_tip", "root_order", "axis_index", "label", "struct_mass", "length", "hexose_consumption_by_growth", "Net_mineral_N_uptake"]].load()
            print("Loaded")
...
class XarrayPlotting:
    ...
    def heatmap(data, row_labels, col_labels, ax=None,
            cbar_kw=None, cbarlabel="", ylog=False, xlog=False, **kwargs):
        """
